...
public struct SVGTransform {
    public enum Component {
        ...
        /// Helper initializer for individual SVGTransform.TransformType
    ...
    public init(_ string: String) {
        ...
        while !scanner.atEnd {
            ...
            if let transform = Component(type: type, parameters: parameters) {
    ...
    public func asAffineTransform() -> AffineTransform {
        ...
        for transform in self.components {
